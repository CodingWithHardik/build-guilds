...
const footerLinks: FooterLink[][] = [
  [
    ...
    { id: 3, title: "Schedule", url: "#" },
    { id: 4, title: "Gallery", url: "#" },
    { id: 5, title: "Team", url: "#" },
    { id: 6, title: "FAQ", url: "#" },
  ],
  [
    { id: 7, title: "Hackclub", url: "#" },
    { id: 8, title: "Blueprint", url: "#" },
    { id: 9, title: "Team", url: "#" },
    { id: 10, title: "Register", url: "#" },
    { id: 11, title: "Slack #build-guild-kanpur", url: "#" },
      ...
      <div className="flex flex-col py-10 md:flex-row md:items-center md:justify-between">
        <div className="flex flex-col items-start justify-start gap-y-5">
          ...
          <p className="text-sm tracking-tight text-bp-warning sm:text-center">
            Made By <a href="https://github.com/CodingWithHardik" className="text-white hover:underline" target="_blank" rel="noopener noreferrer">CodingWithHardik</a>
          </p>
        </div>
