  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        <span
          className="ml-auto flex items-center justify-center w-8 font-normal"
        >
          <span className="group-data-[state=open]/accordion-trigger:inline hidden">[-]</span>
          <span className="group-data-[state=closed]/accordion-trigger:inline hidden">[+]</span>
        </span>
      </AccordionPrimitive.Trigger>
