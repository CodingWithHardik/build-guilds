...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      const secureAttr = typeof window !== "undefined" && window.location.protocol === "https:" ? "; Secure; SameSite=Lax" : "; SameSite=Lax";
      document.cookie = `${SIDEBAR_COOKIE_NAME}=${openState}; path=/; max-age=${SIDEBAR_COOKIE_MAX_AGE}${secureAttr}`
    },
    [setOpenProp, open]
  )
